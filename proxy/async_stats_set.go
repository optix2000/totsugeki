...
func (s *StriveAPIProxy) HandleStatsSet(w http.ResponseWriter, r *http.Request) {
	...
	type statsSetBody struct { // 59 bytes
		...
		Version1  [5]byte  // Some sort of ASCII version number. "0.0.7" in v1.10. "0.0.6" in v1.07. "0.0.5" in v1.06, was "0.0.4" in v1.05
	...
	body := statsSetBody{
		...
		Timestamp: timestamp,
		Spacer2:   [1]byte{0xa5},
		Version1:  [5]byte{0x30, 0x2e, 0x30, 0x2e, 0x37}, // 0.0.7
		Spacer3:   [1]byte{0xa5},
